package io.squark.dynamicjar.test.frameworkprovider.weld;

import io.squark.dynamicjar.frameworkprovider.WeldFrameworkProvider;
...
public class WeldProviderIntegrationTest {
    ...
    @Test
    public void test() {
        Assert.assertTrue(output.contains("io.squark.dynamicjar.weld.test.InjectedClass: HELLO"));
    }
