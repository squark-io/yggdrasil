...
public class CrappyLogger implements Logger {
    ...
    private static final String ASK_LOG_LEVEL = "ask.logLevel";
    ...
    CrappyLogger(String name) {
        ...
        if (System.getProperty(ASK_LOG_LEVEL) != null) {
            logLevel = LogLevel.valueOf(System.getProperty(ASK_LOG_LEVEL));
        }
    }
