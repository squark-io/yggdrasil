...
import io.squark.ask.core.api.logging.LoggingModule;
...
public class Log4j2LoggingModule implements LoggingModule {
    ...
    @Override
    public ILoggerFactory initialize(@Nullable AskConfiguration configuration, @Nullable ClassLoader classLoader,
        @Nullable URL jarWithConfig) throws AskException {

        String systemLogLevel = System.getProperty(Constants.ASK_LOG_LEVEL);
    ...
    private LoggerContext getCustomLoggerContext(Level log4jLevel) throws AskException {
