...
public class JpaProvider implements FrameworkProvider {

    private final Logger logger = InternalLoggerBinder.getLogger(JpaProvider.class);

    @Override
    public void provide(@Nullable YggdrasilConfiguration configuration) throws YggdrasilException {
        logger.info("Initializing " + JpaProvider.class.getSimpleName() + "...");
        ...
        logger.info(JpaProvider.class.getSimpleName() + " initialized.");
    }

    @Override
    public String getName() {
        return JpaProvider.class.getSimpleName();
    }
