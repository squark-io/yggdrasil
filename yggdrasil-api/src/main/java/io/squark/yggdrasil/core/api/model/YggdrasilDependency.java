...
public class YggdrasilDependency implements Serializable {
    ...
    public YggdrasilDependency(String groupId, String artifactId, String extension, String version, File file) {
    ...
    public YggdrasilDependency(String groupId, String artifactId, String extension, String classifier, String version, File file,
        String scope, Set<YggdrasilDependency> children, String provided, Boolean optional) {
    ...
    public void setParent(YggdrasilDependency parent) {
        this.parent = parent;
    }
    ...
    public void setChildDependencies(Set<YggdrasilDependency> childDependencies) {
        this.childDependencies = childDependencies;
    }

    public void addChildDependency(YggdrasilDependency childDependency) {
    ...
    public boolean equals(Object o) {
        ...
        YggdrasilDependency that = (YggdrasilDependency) o;
