package io.squark.dynamicjar.logging.module;
...
import io.squark.dynamicjar.core.api.logging.LoggingModule;
...
public class Log4j2LoggingModule implements LoggingModule {
    ...
    @Override
    public ILoggerFactory initialize(@Nullable DynamicJarConfiguration configuration, @Nullable ClassLoader classLoader,
    ...
    private LoggerContext getCustomLoggerContext(Level log4jLevel) throws DynamicJarException {
