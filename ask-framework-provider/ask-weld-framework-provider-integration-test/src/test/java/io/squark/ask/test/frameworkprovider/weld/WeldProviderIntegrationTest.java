package io.squark.ask.test.frameworkprovider.weld;
...
public class WeldProviderIntegrationTest {
    ...
    public static void setUp(String jacocoArgLine, String targetArtifact) throws Exception {
        ...
        CommandLine commandLine = CommandLine.parse("java -Dask.logLevel=DEBUG " + jacocoArgLine + " -jar " + targetArtifact);
    ...
    @Test
    public void test() {
        Assert.assertTrue(output.contains("io.squark.ask.weld.test.InjectedClass: HELLO"));
    }
